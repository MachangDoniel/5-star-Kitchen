...
void Fridge(Cube& cube, Shader& lightingShader, glm::mat4 alTogether);
...
void ServeTable(Cube& cube, Shader& lightingShader, glm::mat4 alTogether);
...
void CreateLighting(Shader& lightingShaderWithTexture);
void CreateTable(glm::mat4& identityMatrix, glm::mat4& translateMatrix, unsigned int& wood_tex, Cube& cube, Shader& lightingShaderWithTexture);
void CreateChair2(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, unsigned int& wood_tex, Cube& cube, Shader& lightingShaderWithTexture);
void CreateTable2(glm::mat4& identityMatrix, glm::mat4& translateMatrix, unsigned int& wood_tex, Cube& cube, Shader& lightingShaderWithTexture);
void CreateChair(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, glm::mat4& model, unsigned int& wood_tex, Cube& cube, Shader& lightingShaderWithTexture);
void CreateFloor(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& tiles_cube, Shader& lightingShaderWithTexture);
void CreateCeil(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, unsigned int& wall_tex, Cube& cube, Shader& lightingShaderWithTexture);
void CreateFirstRoom(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, Cube& front_wall_cube, Cube& tiles_cube, unsigned int& wall_tex, unsigned int& wood_tex, unsigned int& logo_tex, unsigned int& chair_tex, unsigned int& bed_tex, unsigned int& sofa_tex, unsigned int& sofa2_tex, unsigned int& clock_tex);
void CreateSecondRoom(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, Cube& front_wall_cube, Cube& tiles_cube, unsigned int& wall_tex, unsigned int& wood_tex, unsigned int& logo_tex, unsigned int& chair_tex, unsigned int& bed_tex, unsigned int& sofa_tex, unsigned int& sofa2_tex, unsigned int& clock_tex);
void CreateThirdRoom(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, Cube& front_wall_cube, Cube& tiles_cube, unsigned int& wall_tex, unsigned int& wood_tex, unsigned int& logo_tex, unsigned int& chair_tex, unsigned int& bed_tex, unsigned int& sofa_tex, unsigned int& sofa2_tex, unsigned int& clock_tex);
void CreateFourthRoom(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, Cube& front_wall_cube, Cube& tiles_cube, unsigned int& wall_tex, unsigned int& wood_tex, unsigned int& logo_tex, unsigned int& chair_tex, unsigned int& bed_tex, unsigned int& sofa_tex, unsigned int& sofa2_tex, unsigned int& clock_tex);
void CreateFifthRoom(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, Cube& front_wall_cube, Cube& tiles_cube, unsigned int& wall_tex, unsigned int& wood_tex, unsigned int& logo_tex, unsigned int& chair_tex, unsigned int& bed_tex, unsigned int& sofa_tex, unsigned int& sofa2_tex, unsigned int& clock_tex);
void CreateGrass(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& roof_cube, Shader& lightingShaderWithTexture, unsigned int& grass_tex);
void CreateRoad1(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, unsigned int& road_tex);
void CreateRoad2(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, unsigned int& road_tex);
void CreateRoad3(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, unsigned int& road_tex);
void CreateMainRoad(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, unsigned int& road_tex);
void CreateMuktoMoncho(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, unsigned int& road_tex);
void CreatePool(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, unsigned int& wall_tex, vector<string>& PoolIMG);
void CreateSiri(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, Cube& front_wall_cube, Cube& tiles_cube, unsigned int& wall_tex, unsigned int& wood_tex, unsigned int& logo_tex, unsigned int& chair_tex, unsigned int& bed_tex, unsigned int& sofa_tex, unsigned int& sofa2_tex, unsigned int& clock_tex);
void CreateShowCase(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, Cube& front_wall_cube, Cube& tiles_cube, unsigned int& wall_tex, unsigned int& wood_tex, unsigned int& logo_tex, unsigned int& chair_tex, unsigned int& bed_tex, unsigned int& sofa_tex, unsigned int& sofa2_tex, unsigned int& clock_tex);
void CreateFridge(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, unsigned int& fridge_tex);
void UpdateFridge();
...
float fridgeDoorAngle = 0.0f; // Initial angle for the fridge door
bool fridgeOpen = false;      // State of the fridge (open or closed)
...
string logo = "title.jpg";
string dorja = "dorja.jpg";
string fridge = "fridge.jpg";
...
int main()
{
    ...
    unsigned int fridge_tex = loadTexture(fridge.c_str(), GL_REPEAT, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR);
   ...
   //bazierVAO
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        /*----------------------------------------------------{Create Lighting}----------------------------------------------------*/
        CreateLighting(lightingShaderWithTexture);
        ...
        /*----------------------------------------------------{Create Objects}----------------------------------------------------*/
        CreateGrass(identityMatrix, translateMatrix, scaleMatrix, roof_cube, lightingShaderWithTexture, grass_tex);
        CreateRoad1(identityMatrix, translateMatrix, scaleMatrix, cube, lightingShaderWithTexture, road_tex);
        CreateRoad2(identityMatrix, translateMatrix, scaleMatrix, cube, lightingShaderWithTexture, road_tex);
        CreateRoad3(identityMatrix, translateMatrix, scaleMatrix, cube, lightingShaderWithTexture, road_tex);
        CreateMainRoad(identityMatrix, translateMatrix, scaleMatrix, cube, lightingShaderWithTexture, road_tex);
        //CreateMuktoMoncho(identityMatrix, translateMatrix, scaleMatrix, cube, lightingShaderWithTexture, road_tex);
        //CreatePool(identityMatrix, translateMatrix, scaleMatrix, cube, lightingShaderWithTexture, wall_tex, PoolIMG);
        CreateTable(identityMatrix, translateMatrix, wood_tex, cube, lightingShaderWithTexture);
		CreateChair(identityMatrix, translateMatrix, scaleMatrix, model, wood_tex, cube, lightingShaderWithTexture);
		//CreateTable2(identityMatrix, translateMatrix, wood_tex, cube, lightingShaderWithTexture);
		//CreateChair2(identityMatrix, translateMatrix, scaleMatrix, wood_tex, cube, lightingShaderWithTexture);
		CreateFloor(identityMatrix, translateMatrix, scaleMatrix, tiles_cube, lightingShaderWithTexture);
        CreateCeil(identityMatrix, translateMatrix, scaleMatrix, wall_tex, cube, lightingShaderWithTexture);
        ...
        //CreateFirstRoom(identityMatrix, translateMatrix, scaleMatrix, cube, lightingShaderWithTexture, front_wall_cube, tiles_cube, wall_tex, wood_tex, logo_tex, chair_tex, bed_tex, sofa_tex, sofa2_tex, clock_tex);
        CreateSecondRoom(identityMatrix, translateMatrix, scaleMatrix, cube, lightingShaderWithTexture, front_wall_cube, tiles_cube, wall_tex, wood_tex, logo_tex, chair_tex, bed_tex, sofa_tex, sofa2_tex, clock_tex);
        CreateThirdRoom(identityMatrix, translateMatrix, scaleMatrix, cube, lightingShaderWithTexture, front_wall_cube, tiles_cube, wall_tex, wood_tex, logo_tex, chair_tex, bed_tex, sofa_tex, sofa2_tex, clock_tex);
        CreateFourthRoom(identityMatrix, translateMatrix, scaleMatrix, cube, lightingShaderWithTexture, front_wall_cube, tiles_cube, wall_tex, wood_tex, logo_tex, chair_tex, bed_tex, sofa_tex, sofa2_tex, clock_tex);
		CreateFifthRoom(identityMatrix, translateMatrix, scaleMatrix, cube, lightingShaderWithTexture, front_wall_cube, tiles_cube, wall_tex, wood_tex, logo_tex, chair_tex, bed_tex, sofa_tex, sofa2_tex, clock_tex);
		CreateSiri(identityMatrix, translateMatrix, scaleMatrix, cube, lightingShaderWithTexture, front_wall_cube, tiles_cube, wall_tex, wood_tex, logo_tex, chair_tex, bed_tex, sofa_tex, sofa2_tex, clock_tex);
		CreateShowCase(identityMatrix, translateMatrix, scaleMatrix, cube, lightingShaderWithTexture, front_wall_cube, tiles_cube, wall_tex, wood_tex, logo_tex, chair_tex, bed_tex, sofa_tex, sofa2_tex, clock_tex);
        // Update the fridge animation
        UpdateFridge();
        // Rendering commands
        /*glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);*/
        CreateFridge(identityMatrix, translateMatrix, scaleMatrix, cube, lightingShaderWithTexture, fridge_tex);
...
//
//}
void FWall(Cube& cube, Shader& lightingShadspoter, glm::mat4 alTogether)
{
    glm::mat4 identityMatrix = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first
    glm::mat4 translateMatrix, rotateXMatrix, rotateYMatrix, rotateZMatrix, scaleMatrix, model;
...
void Fridge(Cube& cube, Shader& lightingShader, glm::mat4 alTogether) {
    ...
    // Fridge body (main compartment)
    model = transform(0, 0, 0, 0, 0, 0, 4, 8, 4); // Tall rectangular body
    cube.drawCubeWithTexture(lightingShader, alTogether * model);

    // Left border
    model = transform(-2.05, 0, 0, 0, 0, 0, 0.1, 8, 4); // Thin left wall
    cube.drawCubeWithTexture(lightingShader, alTogether * model);

    // Right border
    model = transform(2.05, 0, 0, 0, 0, 0, 0.1, 8, 4); // Thin right wall
    cube.drawCubeWithTexture(lightingShader, alTogether * model);

    // Top border
    model = transform(0, 4.05, 0, 0, 0, 0, 4.2, 0.1, 4); // Thin top panel
    cube.drawCubeWithTexture(lightingShader, alTogether * model);

    // Bottom border
    model = transform(0, -4.05, 0, 0, 0, 0, 4.2, 0.1, 4); // Thin bottom panel
    cube.drawCubeWithTexture(lightingShader, alTogether * model);

    // Fridge door
    translateMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(2.05, 0, 0));
    glm::mat4 rotationMatrix = glm::rotate(glm::mat4(1.0f), glm::radians(fridgeDoorAngle), glm::vec3(0, 1, 0)); // Rotate around Y-axis
    model = translateMatrix * rotationMatrix;
    model = transform(model[3][0], model[3][1], model[3][2], 0, 0, 0, 0.1, 8, 4); // Door covers the entire height
    cube.drawCubeWithTexture(lightingShader, alTogether * model);

    // Fridge door handle
    translateMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(2.2, 0, 1.5)); // Handle positioned on the door
    rotationMatrix = glm::rotate(glm::mat4(1.0f), glm::radians(fridgeDoorAngle), glm::vec3(0, 1, 0)); // Rotate with the door
    model = translateMatrix * rotationMatrix;
    model = transform(model[3][0], model[3][1], model[3][2], 0, 0, 0, 0.1, 1.5, 0.2); // Small handle
    cube.drawCube(lightingShader, alTogether * model, 0, 0, 0);
}
//void ServeTable(Cube& cube, Shader& lightingShader, glm::mat4 alTogether)
//{
...
void CreateFourthRoom(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, Cube& front_wall_cube, Cube& tiles_cube, unsigned int& wall_tex, unsigned int& wood_tex, unsigned int& logo_tex, unsigned int& chair_tex, unsigned int& bed_tex, unsigned int& sofa_tex, unsigned int& sofa2_tex, unsigned int& clock_tex) {
    ...
    cube.setTextureProperty(wood_tex, wood_tex, 32.0f);
    ServeTable(cube, lightingShaderWithTexture, translateMatrix * scaleMatrix);
...
void CreateFridge(glm::mat4& identityMatrix, glm::mat4& translateMatrix, glm::mat4& scaleMatrix, Cube& cube, Shader& lightingShaderWithTexture, unsigned int& fridge_tex) {
    translateMatrix = glm::translate(identityMatrix, glm::vec3(48.5, 0.5, 3.25));
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(-1, 1, -1)); // Adjust door size
    cube.setTextureProperty(fridge_tex, fridge_tex, 32.0f);
    Fridge(cube, lightingShaderWithTexture, translateMatrix * scaleMatrix);
}
void UpdateFridge() {
    if (fridgeOpen && fridgeDoorAngle < 90.0f) {
        fridgeDoorAngle += 10.0f; // Increment to open
    }
    else if (!fridgeOpen && fridgeDoorAngle > 0.0f) {
        fridgeDoorAngle -= 10.0f; // Decrement to close
    }
}
